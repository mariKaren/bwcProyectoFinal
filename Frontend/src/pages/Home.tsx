    ...
    return (
        ...
        {/* Portada */}
            <section className="relative text-beige bg-brown rounded-lg overflow-hidden h-64 flex items-center justify-center px-6">
                ...
                <div className="relative z-10 text-center font-text max-w-3xl">
                    <h1 className="text-2xl md:text-4xl font-bold mb-5 drop-shadow-lg">
                        Descubre tu próximo gran libro
                    </h1>
                    <NavLink to="/libros/busqueda" className="bg-beige text-brown font-semibold px-6 py-2 rounded-md hover:bg-yellow transition inline-block text-md">
                        Explorar ahora
                    </NavLink>
                </div>
            </section>
